...
export default class FormKayitOgretmen extends Component<{}>{
  constructor(props) {
        super(props);
       // this.inputRefs = {};
  this.state = {
            ...
            items2: [
                {
                    label: 'Matematik Öğretmeni',
                    value: 'mat',
                },
                {
                    label: 'Türkçe Öğretmeni',
                    value: 'türkce',
                },
                {
                    label: 'İngilizce Öğretmeni',
                    value: 'ingilizce',
                },
                {
                    label: 'Fizik Öğretmeni',
                    value: 'fizik',
                },
                {
                    label: 'Kimya Öğretmeni',
                    value: 'kimya',
                },
                {
                    label: 'Biyoloji Öğretmeni',
                    value: 'biyoloji',
                },
                {
                    label: 'Tarih Öğretmeni',
                    value: 'tarih',
                },
                {
                    label: 'Coğrafya Öğretmeni',
                    value: 'coğrafya',
                },
            ],
            cinsiyet: undefined,
